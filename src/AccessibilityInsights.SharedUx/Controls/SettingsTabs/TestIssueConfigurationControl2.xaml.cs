...
namespace AccessibilityInsights.SharedUx.Controls.SettingsTabs
{
    ...
    /// </summary>
    public partial class TestIssueConfigurationControl2 : IssueConfigurationControl, INotifyPropertyChanged
    {
        ...
        public TestIssueConfigurationControl2(Action UpdateSaveButton)
        {
            InitializeComponent();
